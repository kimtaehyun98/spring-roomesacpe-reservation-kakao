...
public class RepositoryTest {
    ...
    public RepositoryTest() {
        ...
        themeRequest = new ThemeRequest("name", "desc", 1000);
    }
    ...
    void save() {
        Long id = themeRepository.save(makeTheme(1L, themeRequest));
    ...
    void find() {
        Long id = themeRepository.save(makeTheme(1L, themeRequest));
        Theme before = makeTheme(id, themeRequest);
    ...
    private Theme makeTheme(Long id, ThemeRequest req){
